...
export const CATEGORIES = [
  ...
  },
  {
    ...
    brands: [
      ...
      "NERDS", "NUTELLA", "OLD EL PASO", "OREO'S", "PEZ", "POP TARTS", "PRINGLES",
  ...
  },
  {
    ...
    brands: [
      ...
      "MASTERS OF THE UNIVERSE", "NEIGHBOURS", "NETFLIX", "NICKELODEAN", "PBS",
  ...
  },
  {
    ...
    brands: [
      ...
      "FORTNITE", "GARBAGE PAIL KIDS", "GRAND THEFT AUTO", "HOT WHEELS", "KONAMI", "LEGO",
  ...
  },
  {
    ...
    brands: [
      ...
      "TWITCH", "TWITTER", "UPS", "YAHOO!", "YOUTUBE", "YUBO",
    ],
  },
  {
    id: "street",
    ...
    color: "#2d6a4f",
    brands: [
      "ALIEN WORKSHOP", "ATLANTA HAWKS", "BIC", "BMW", "CAT", "CASTROL", "PALACE",
      "CHICAGO BULLS", "D.A.R.E", "DICKHOUSE", "DUCATI", "DUCATI CLASSIC",
      "ESSO", "FERRARI", "FORD", "GIRL", "GOODYEAR", "GULF", "HILTI",
      "HONDA", "LAND ROVER", "LUCKY STRIKE", "MOBIL", "OBEY", "PLAYBOY",
      "RAIDERS", "SANTA CRUZ", "SHELL", "SUPREME", "THRASHER", "TOY MACHINE", "WWF",
    ],
  },
];
